...
def data_get():
    city = city_name.get()
    url = f"https://api.openweathermap.org/data/2.5/weather?q={city}&appid=6b4d3f7fcaf0b11bb8a12a56a8d70924"
...
com = ttk.Combobox(win, values=list_name, font=("Times New Roman", 22, "bold"), textvariable=city_name)
